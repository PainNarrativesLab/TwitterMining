...
class CouchDAO:
    ...
    def query(self, query_string):
        """
        Run word_map_table_creation_query on couch db
        Args:
            query_string: String word_map_table_creation_query to run
        Returns:
            Dictionary result of word_map_table_creation_query
        """
        try:
            if self._check_connected():
